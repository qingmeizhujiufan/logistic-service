...
class DeviceProviderServiceList extends React.Component {
  constructor(props) {
    super(props);
    ...
    const row = (rowData, sectionID, rowID) => {
      ...
      return (
        <div key={rowID} className='zui-table-cell'>
            <Link to={{pathname: '/deviceProvider/deviceRepairsDetail/' + obj.id}}>
    ...
    return (
      <div>
        <NavBar
          ...
          rightContent={
            <Link to={{pathname: '/deviceProvider/deviceRepairsAdd/'}}>
...
DeviceProviderServiceList.contextTypes = {  
     router:React.PropTypes.object  
} 

export default  DeviceProviderServiceList;
