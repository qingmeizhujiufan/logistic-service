        ...
        <div className='zui-content'>
          ...
          <List className="my-list" style={{marginTop:'10px'}}>
                <List.Item
                  ...
                  >完成情况</List.Item>
                <List.Item extra={this.state.matType ==1 ? '保养' : ''}>维保类型</List.Item>
                <Picker 
                ...
                >
                  <List.Item arrow="horizontal">保养等级</List.Item>
                </Picker> 
                <List.Item extra={
                  <TextareaItem  
                    rows = {2}
                ...
                检查人员</List.Item>
                 ...
                 <DatePicker
                   ...
                   >
                   <List.Item arrow="horizontal">保养结束时间</List.Item>
                 </DatePicker>
          </List>
          <List className="my-list" style={{marginTop:'10px'}}>
           <List.Item >保养内容
